...
export const COMPANY_ATS_REGISTRY: CompanyAtsConfig[] = [
  ...
  { company: "Adobe",           ats: "workday", careersUrl: "https://adobe.wd5.myworkdayjobs.com/external_career",               adapter: "workday", enabled: true  },
  { company: "Intel",           ats: "workday", careersUrl: "https://intel.wd1.myworkdayjobs.com/External",                      adapter: "workday", enabled: true  },
  { company: "Wells Fargo",     ats: "workday", careersUrl: "https://wellsfargo.wd1.myworkdayjobs.com/WF_External_Careers",      adapter: "workday", enabled: true  },
  { company: "Capital One",     ats: "workday", careersUrl: "https://capitalone.wd1.myworkdayjobs.com/Capital_One_External",     adapter: "workday", enabled: true  },
  ...
  { company: "Home Depot",      ats: "workday", careersUrl: "https://homedepot.wd5.myworkdayjobs.com/External",                 adapter: "workday", enabled: true  },
  ...
  { company: "Morgan Stanley",  ats: "workday", careersUrl: "https://morganstanley.wd5.myworkdayjobs.com/External",             adapter: "workday", enabled: true  },
  ...
  { company: "Snowflake",    ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/snowflake",    adapter: "greenhouse", enabled: true },
  { company: "HashiCorp",    ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/hashicorp",    adapter: "greenhouse", enabled: true },
  ...
  { company: "Confluent",    ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/confluent",    adapter: "greenhouse", enabled: true },
  ...
  { company: "PayPal",       ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/paypal",       adapter: "greenhouse", enabled: true },
  { company: "Visa",         ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/visa",         adapter: "greenhouse", enabled: true },
  { company: "Mastercard",   ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/mastercard",   adapter: "greenhouse", enabled: true },
  { company: "Infosys",      ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/infosys",      adapter: "greenhouse", enabled: true },
  { company: "Cognizant",    ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/cognizant",    adapter: "greenhouse", enabled: true },
  { company: "Accenture",    ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/accenture",    adapter: "greenhouse", enabled: true },
  { company: "Capgemini",    ats: "greenhouse", careersUrl: "https://boards.greenhouse.io/capgemini",    adapter: "greenhouse", enabled: true },
