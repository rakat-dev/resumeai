...
export const COMPANY_ATS_REGISTRY: CompanyAtsConfig[] = [
  ...
  { company: "Walmart",         ats: "workday", careersUrl: "https://walmart.wd5.myworkdayjobs.com/WalmartExternal",            adapter: "walmart_cxs", enabled: true,
    note: "Direct Workday CXS backend (2026-04-18). POST to /wday/cxs/walmart/WalmartExternal/jobs with Job_Profiles facet. 4 profiles: Senior SWE InfoSec, Senior SWE, SWE III, SWE II. 265 jobs total. Replaces Adzuna targeted fetch which returned only ~38 jobs with broken apply links." },
