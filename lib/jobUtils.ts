...
export const NO_SPONSORSHIP_PATTERNS: RegExp[] = [
  ...
  /\bcannot provide sponsorship\b/i,
  /\bunable to sponsor\b/i,
  /\bno h-1b sponsorship\b/i,
  /\bnot available for opt\b/i,
  /\bnot available for cpt\b/i,
  /\bnot considering candidates who require sponsorship\b/i,
  /\bmust be authorized to work in the (?:u\.?s\.?|united states) without (?:current or future )?sponsorship\b/i,
  /\bmust be legally authorized to work in the (?:u\.?s\.?|united states) without (?:current or future )?sponsorship\b/i,
  /\bauthorized to work in the (?:u\.?s\.?|united states) without (?:current or future )?sponsorship\b/i,
  /\bwithout current or future sponsorship\b/i,
  /\bwithout employer sponsorship\b/i,
...
const YES_SPONSORSHIP_PATTERNS: RegExp[] = [
  /\bvisa sponsorship available\b/i,
  /\bsponsorship is available\b/i,
  /\bwe sponsor\b/i,
  /\bwe will sponsor\b/i,
  /\bwill sponsor qualified candidates\b/i,
  /\bwill provide sponsorship\b/i,
  /\bcan provide sponsorship\b/i,
  /\bsponsorship provided\b/i,
  /\bemployment sponsorship available\b/i,
];
